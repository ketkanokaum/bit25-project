...
export const THAI_TO_GEOJSON_NAME = {
  ...
  กรุงเทพมหานคร: 'Bangkok Metropolis', พิษณุโลก: 'Phitsanulok', สุโขทัย: 'Sukhothai', เพชรบูรณ์: 'Phetchabun',
  ...
  หนองบัวลำภู: 'Nong Bua Lam Phu', เลย: 'Loei', มุกดาหาร: 'Mukdahan', กาฬสินธุ์: 'Kalasin',
  ...
  กระบี่: 'Krabi', พังงา: 'Phangnga', ภูเก็ต: 'Phuket', พัทลุง: 'Phatthalung', ตรัง: 'Trang',
  ปัตตานี: 'Pattani', สงขลา: 'Songkhla', สตูล: 'Satun', นราธิวาส: 'Narathiwat', ยะลา: 'Yala',
};

export const GEOJSON_TO_THAI_NAME = Object.fromEntries(
  Object.entries(THAI_TO_GEOJSON_NAME).map(([thai, geo]) => [geo, thai])
);
